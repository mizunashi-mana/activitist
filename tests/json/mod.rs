...
fn serialize_object() {
    ...
    let serialized_data = data.to_value().unwrap();
    let expected_data = r#"{
        "@context": [
          "https://www.w3.org/ns/activitystreams",
    ...
    let expected_data: ap_model::Object = ap_model::Object::from_json_str(expected_data).unwrap();
    let expected_data = expected_data.to_value().unwrap();
